...
import { ArrowLeft, Users, Copy, CheckCircle, AlertCircle, Gamepad2, Shield, Zap } from "lucide-react"
...
export function TournamentWaitingRoom({ tournamentName, slotId, onBack, onLeaveTournament }: WaitingRoomProps) {
  const [timeLeft, setTimeLeft] = useState(125 * 60) // 2h 5m in seconds
  ...
  // Simulate receiving room details from admin
  useEffect(() => {
